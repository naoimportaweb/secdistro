...
class SetupMainWindow:
    ...
    def setup_gui(self):
        ...
        if self.settings["custom_title_bar"]:
            ...
            self.ui.title_bar.set_title("Security Dashboard")
        ...
        self.logo_svg = QSvgWidget(Functions.set_svg_image("logo_home.svg_"))
        ...
        for x in range(10):
            ...
            self.table_widget.setItem(row_number, 0, QTableWidgetItem(str("Usuario linux"))) # Add name
            self.table_widget.setItem(row_number, 1, QTableWidgetItem(str("vfx_on_fire_" + str(x)))) # Add nick
            self.pass_text = QTableWidgetItem()
            self.pass_text.setTextAlignment(Qt.AlignCenter)
            self.pass_text.setText("********" + str(x))
